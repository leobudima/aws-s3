...
var Signature = function () {
    ...
    Signature.getSignature = function getSignature(config, date, policyBase64) {
...
var Policy = function () {
    function Policy() {
        _classCallCheck$1(this, Policy);
    }

    Policy.getPolicy = function getPolicy(config) {
...
var throwError = function throwError(_ref, file) {
...
var S3Client = function () {
    function S3Client() {
        _classCallCheck$2(this, S3Client);
    }

    S3Client.uploadFile = function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(file, config) {
    ...
    S3Client.deleteFile = function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(fileName, config) {
